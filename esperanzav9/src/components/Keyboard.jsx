...
function renderKeyContent(key, label) {
  if (key === "BACKSPACE") {
    return (
      <span className="flex flex-col items-center justify-center leading-none">
        <MdBackspace className="text-[28px]" />
      </span>
    );
  }
  ...
  if (key === "ENTER2") {
    return (
      <span className="flex flex-col items-center justify-center leading-none">
        <MdKeyboardReturn className="text-[28px]" />
      </span>
    );
  }
  ...
  if (key === "KEYBOARD") {
    return (
      <span className="flex flex-col items-center justify-center leading-none">
        <MdKeyboardHide className="text-[2px]" />
      </span>
    );
  }
...
export default function Keyboard({ pressedKeys = new Set(), onKeyPress, labels = {}, mode = 'letters' }) {
  ...
  return (
    <div className="ms-auto w-full rounded-[35px] bg-white p-3 md:p-4 mon-h-[2in] md:min-h-[4in] shadow-inner">
      <div className="space-y-3 md:space:space-y-3">
